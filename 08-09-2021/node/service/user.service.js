...
module.exports = {
    ...
    updateUser: async (id, body) => {
        ...
        if (data) {
            return { statusCode: config.statusCode.ok, message: "User Updated successfully", data: data }
        }
        return { statusCode: config.statusCode.serverIssue, message: config.message.serverIssue }
    },
    ...
    getPendingProfessor: async () => {
        ...
        if (data) {
            return { statusCode: config.statusCode.ok, message: "Successfully readed data", data: data }
        }
